...
//Every half a second website resizes the relativity of page elements appropriately in reference to the yellow rectangluar background.
setInterval(function()
{
    ...
    extraSpace2.style.marginTop = -rBGHeight + "px";
},500);
